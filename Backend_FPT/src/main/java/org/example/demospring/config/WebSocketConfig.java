                        ...
                        try {
                            ...
                            if (username != null) {
                                ...
                                if (jwtUtil.validateToken(token, userDetails)) {
                                    ...
                                    throw new org.springframework.messaging.MessageDeliveryException("Token is not valid");
                                }
                            }
                        } catch (Exception e) {
                            throw new org.springframework.messaging.MessageDeliveryException("Unauthorized access");
                        }
                    } else {
